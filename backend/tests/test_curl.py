...
def main():
    ...
    print("="*80)
    res = httpx.post("http://localhost:8000/resolve", json={"pnr": "AB12CD", "full_name": "Dhyan Mehta"})
    print(f"Status: {res.status_code}")
    print("Body:")
    print(json.dumps(res.json(), indent=2))
    ...
    print("="*80)
    res = httpx.post("http://localhost:8000/resolve", json={"pnr": "ZZ77XX", "full_name": "Anil Verma"})
    print(f"Status: {res.status_code}")
    print("Body:")
    print(json.dumps(res.json(), indent=2))
    ...
    print("="*80)
    res = httpx.post("http://localhost:8000/resolve", json={"pnr": "AB12CD", "full_name": "Wrong Name"})
    print(f"Status: {res.status_code}")
    print("Body:")
    print(json.dumps(res.json(), indent=2))
